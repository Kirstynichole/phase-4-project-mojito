    ...
    return (
        <div className="mt-20 absolute top-20 px-8 lg:px-20 xl:px-40">
            ...
            <div className='border-double border-2 border-mojitoGrey bg-mojitoBlue text-mojitoGrey rounded-xl m-5 mt-10 p-5 py-10 px-8'>
                ...
                <h3>Trying to get a better hold of your finances? Don't know how much you spend per month? Want to keep better track of or be more responsible with your spending on certain categories? That's what we're here for.</h3>
                <br/>
            ...
            <ul className='mx-5 flex justify-between text-center'>
                ...
                <li className='flex-grow inline-block rounded-xl border-double border-2 border-mojitoBlue p-3 mx-1 bg-mojitoPeriwinkle'>Add monthly income & desired savings.</li>
                <li className='flex-grow inline-block rounded-xl border-double border-2 border-mojitoBlue p-3 mx-1 bg-mojitoPeriwinkle'>Choose categories to track.</li>
